...
func InitGlobalFlags(logger *slog.Logger, cmd *cobra.Command, vp *viper.Viper) {
	...
	flags.Bool(option.EnableSIPInspection, true, "Enable 46labs SIP inspection, Call-ID conntrack keys and SIP-specific LB/NAT (restart required; drain SIP traffic before changing)")

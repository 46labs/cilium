...
static inline __u8 is_sip(const char *cur, const char *data_end)
{
	...
	// 8 bytes with space
	static const __u64 options = 0x20736e6f6e74706f; // "options "
	static const __u64 message = 0x206567637173656d; // "message "
	...
	static const __u64 notify = 0x0020796669736f6e; // "notify "

	// 6 bytes match
	static const __u64 prack = 0x0000206b63617270; // "prack "
	static const __u64 refer = 0x000020726566572;  // "refer "
	...
	__u64 v_masked7 = 0x0020202020202020;

...
// addSIPInspectionDefine emits the compile-time switch for the SIP inspection.
// When disabled, the SIP parser and all SIP-specific
// datapath branches are compiled out of the BPF programs.
